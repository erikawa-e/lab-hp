...
permalink: /export/
title: Export
description: Data downloads for import to Researchmap and ORCID
nav: false
---

<p style="font-size:0.9em; color:#666; margin-bottom:1.5rem;">
Enter a date range in each section and download a CSV, then upload it via Researchmap's "Import" function. Leave blank to include all entries.
</p>
...
<div style="margin-bottom:0.5rem; font-size:0.9em;">
  <label>From:</label>
  <input id="pres-year" type="number" placeholder="Year" min="2000" max="2099" style="width:5em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Year
  <input id="pres-month" type="number" placeholder="Month" min="1" max="12" style="width:4em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Month onwards
...
<div style="margin-bottom:0.5rem; font-size:0.9em;">
  <label>From:</label>
  <input id="award-year" type="number" placeholder="Year" min="2000" max="2099" style="width:5em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Year
  <input id="award-month" type="number" placeholder="Month" min="1" max="12" style="width:4em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Month onwards
...
<div style="margin-bottom:0.5rem; font-size:0.9em;">
  <label>From:</label>
  <input id="outreach-year" type="number" placeholder="Year" min="2000" max="2099" style="width:5em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Year
  <input id="outreach-month" type="number" placeholder="Month" min="1" max="12" style="width:4em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Month onwards
...
<div style="margin-bottom:0.5rem; font-size:0.9em;">
  <label>From:</label>
  <input id="paper-year" type="number" placeholder="Year" min="2000" max="2099" style="width:5em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Year
  <input id="paper-month" type="number" placeholder="Month" min="1" max="12" style="width:4em; padding:2px 6px; border:1px solid #ccc; border-radius:3px;">
  Month onwards
  <button onclick="downloadPapersCSV()" class="btn btn-sm z-depth-0" style="font-size:0.9em;">Researchmap CSV ↓</button>
  &nbsp;
  <a href="{{ '/assets/papers.bib' | relative_url }}" download="papers.bib" class="btn btn-sm z-depth-0" style="font-size:0.9em;">BibTeX ↓ (for ORCID)</a>
</div>
