...
<p style="font-size: 0.85em; color: #888; margin-bottom: 1rem;">Japanese-language outreach activities are listed on the <a href="{{ '/ja/outreach/' | relative_url }}">Japanese page</a> only.</p>
